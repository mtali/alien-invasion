...
class AlienInvasion:
    ...
    def _create_alien(self, alien_number, row_number):
        alien = Alien(self)
        alient_width, alien_height = alien.rect.size
    ...
    def _create_fleet(self):
        ...
        available_space_x = self.settings.screen_width - (2 * alient_width)
        number_aliens_x = available_space_x // (2 * alient_width)
    ...
    def _ship_hit(self):
        ...
        if self.stats.ships_left > 0:
            self.stats.decrement_ship_left()
